...
//AGFINST
    ...
    public static final int LIME = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.Lime);

    public static final int PURPLE = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.purple);
    public static final int PURPLES = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.purples);

    public static final int PeachPuff = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.PeachPuff);
    public static final int BBLUE = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.RoyalBlue);
    public static final int BCYAN = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.cyan);
    public static final int BYELLOW = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.yellow);

    public static final int TEAL = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.teal300);
    public static final int GOLD = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.Gold);
    public static final int DARKGOLDENROD = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.DarkGoldenrod);

    public static final int GREENDARK = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.DarkGreen);
    public static final int WHOTPINK = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.hotred);

    public static final int WMIDNIHTBLUE = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.midnightblue);
    public static final int WBURNTUMBER = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.burntamber);

    public static final int KASHMIRIGREEN = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.kashmirigreen);
    public static final int MIDNIGHTBLUE = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.midnightblue);
    public static final int INDIGO = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.indigo);
    public static final int ORANGE400 = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.orange400);
    public static final int DARKMAGENTA = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.DarkMagenta);
    public static final int TEAL400 = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.teal400);
    public static final int ORANGE100 = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.orange100);
    public static final int LIGHTPINK = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.LightPink);
    public static final int CYANLIGHT = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.cyan_light);
    public static final int MUSLIMMATE = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.colorMuslimMate);

    public static final int CYANLIGHTEST = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.cyan_lightest);
    public static final int ORANGERED = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.OrangeRed);
    public static final int GREENYELLOW = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.GreenYellow);
    public static final int HOTPINK = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.HotPink);
    public static final int SALMON = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.Salmon);
    public static final int BROWN = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.LightSlateGray);
    public static final int MEDIUMSLATEBLUE = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.MediumSlateBlue);
    public static final int DarkTurquoise = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.Lavender);
    public static final int DeepPink = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.DeepPink);
    public static final int Fuchsia = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.Fuchsia);
    public static final int pinkshade = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.pinkshade);
    public static final int Magenta = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.Magenta);
    public static final int prussianblue = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.prussianblue);
    public static final int deepburnsienna = ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.deepburnsienna);
    ...
    public static ForegroundColorSpan prepositionspanLight = new ForegroundColorSpan(ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.rustred));
    public static ForegroundColorSpan resumtionspanLight = new ForegroundColorSpan(HOTPINK);
    public static ForegroundColorSpan pronounspanLight = new ForegroundColorSpan(ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.steelemetal));
    public static ForegroundColorSpan attachedpronounspanLight = new ForegroundColorSpan(ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.steelemetal));
    public static ForegroundColorSpan determinerspanLight = new ForegroundColorSpan(ContextCompat.getColor(VerbConjugaorApp.getContext(), R.color.steelemetal));
    ...
    public static ForegroundColorSpan harfsababiaspanLight = new ForegroundColorSpan(DARKMAGENTA);
    ...
    public static ForegroundColorSpan masdariaspanDark = new ForegroundColorSpan(LIME);
