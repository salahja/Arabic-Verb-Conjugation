...
public class IsmAlaSarfKabeerAdapter extends RecyclerView.Adapter<IsmAlaSarfKabeerAdapter.ViewHolder> {
    ...
    private void IsmAlaMifalatun(ViewHolder holder){


        String mifalatunone = sarfSagheer.get(1).get(0).toString();//String mifalatunone);
        String mifalatuntwo = sarfSagheer.get(1).get(1).toString();//String mifalatuntwo);
        String mifalatunthree = "-";//String mifalatunthree);

        String mifalatunfour = sarfSagheer.get(1).get(2).toString();//String mifalatunfour);
        String mifalatunfive = sarfSagheer.get(1).get(3).toString();//String mifalatunfive);
        String mifalatunsix = "-";//String mifalatunsix);

        String mifalatunseven = sarfSagheer.get(1).get(4).toString();//String mifalatunseven);
        String mifalatuneight = sarfSagheer.get(1).get(5).toString();//String mifalatuneight);
...
// --Commented out by Inspection START (17/12/21, 7:16 AM):
//        public void SetOnItemClickListener ( final OnItemClickListener mItemClickListener){
//            this.mItemClickListener = mItemClickListener;
//        }
// --Commented out by Inspection STOP (17/12/21, 7:16 AM)
