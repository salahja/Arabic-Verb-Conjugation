...
public class VerbSarfKabeerAdapter extends RecyclerView.Adapter<VerbSarfKabeerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        MadhiMaroof(holder);
        MudhariMaroof(holder);
        MadhiMajhool(holder);
        MudhariMajhool(holder);
        Amar(holder);
        AmarNahi(holder);
        pronouns(holder);
    ...
    private void AmarNahi(ViewHolder holder) {
        ...
        if (isTraditional) {
            ...
            sb.append("-");
            sb.append(sarfSagheer.get(5).get(0).toString());
            anta = sb.toString();
            ...
            sb.append(sarfSagheer.get(5).get(2).toString());
            antuma = sb.toString();
            ...
            sb.append(sarfSagheer.get(5).get(3).toString());
            antum = sb.toString();
            ...
            sb.append(sarfSagheer.get(5).get(1).toString());
            anti = sb.toString();
            ...
            sb.append(sarfSagheer.get(5).get(4).toString());
            antunna = sb.toString();
            ...
            anta = sarfSagheer.get(5).get(0).toString();
            antuma = sarfSagheer.get(5).get(2).toString();
            antum = sarfSagheer.get(5).get(3).toString();
            anti = sarfSagheer.get(5).get(1).toString();
            antumaf = sarfSagheer.get(5).get(2).toString();
            antunna = sarfSagheer.get(5).get(4).toString();
    ...
    private void Amar(ViewHolder holder) {
        String   anta, antuma, antum, anti, antumaf, antunna ;
        SharedPref sf = new SharedPref(context);
        Boolean isTraditional = SharedPref.GetSarfKabeerVerb();
        String[] arraypronouns = context.getResources().getStringArray(R.array.arabicpronouns);
        ...
        if (isTraditional) {
            ...
            sb.append(arraypronouns[6]);
            sb.append("-");
            sb.append(sarfSagheer.get(4).get(0).toString());
            anta = sb.toString();
            ...
            sb.append(sarfSagheer.get(4).get(2).toString());
            antuma = sb.toString();

            sb = new StringBuilder();
            sb.append(arraypronouns[8]);
            sb.append("-");
            sb.append(sarfSagheer.get(4).get(3).toString());
            antum = sb.toString();

            sb = new StringBuilder();
            sb.append(arraypronouns[9]);
            sb.append("-");
            sb.append(sarfSagheer.get(4).get(1).toString());
            anti = sb.toString();
            ...
            sb.append(arraypronouns[11]);
            sb.append("-");
            sb.append(sarfSagheer.get(4).get(4).toString());
            antunna = sb.toString();
            ...
            anta = sarfSagheer.get(4).get(0).toString();
            antuma = sarfSagheer.get(4).get(2).toString();
            antum = sarfSagheer.get(4).get(3).toString();
            anti = sarfSagheer.get(4).get(1).toString();
            antumaf = sarfSagheer.get(4).get(2).toString();
            antunna = sarfSagheer.get(4).get(4).toString();
    ...
    private void MudhariMajhool(ViewHolder holder) {
        ...
        if (isTraditional) {
            ...
            sb.append("-");
            sb.append(sarfSagheer.get(3).get(0).toString());
            hua = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(1).toString());
            huma = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(2).toString());
            hum = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(3).toString());
            hia = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(4).toString());
            humaf = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(5).toString());
            hunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(6).toString());
            anta = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(7).toString());
            antuma = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(8).toString());
            antum = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(9).toString());
            anti = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(10).toString());
            antunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(11).toString());
            ana = sb.toString();
            ...
            sb.append(sarfSagheer.get(3).get(12).toString());
            nahnu = sb.toString();


        } else {

            hua = sarfSagheer.get(3).get(0).toString();
            huma = sarfSagheer.get(3).get(1).toString();
            hum = sarfSagheer.get(3).get(2).toString();
            hia = sarfSagheer.get(3).get(3).toString();
            humaf = sarfSagheer.get(3).get(4).toString();
            hunna = sarfSagheer.get(3).get(5).toString();
            anta = sarfSagheer.get(3).get(6).toString();
            antuma = sarfSagheer.get(3).get(7).toString();
            antum = sarfSagheer.get(3).get(8).toString();
            anti = sarfSagheer.get(3).get(9).toString();
            antumaf = sarfSagheer.get(3).get(4).toString();
            antunna = sarfSagheer.get(3).get(10).toString();
            ana = sarfSagheer.get(3).get(11).toString();
            nahnu = sarfSagheer.get(3).get(12).toString();
        }
...
//
    ...
    private void FontSIzeSelection(ViewHolder holder) {
        final int arabicFontsize = SharedPref.arabicFontsize();
    ...
    private void MadhiMajhool(ViewHolder holder) {
        ...
        if (isTraditional) {
            ...
            sb.append(arraypronouns[0]);
            sb.append("-");
            sb.append(sarfSagheer.get(1).get(0).toString());
            hua = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(1).toString());
            huma = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(2).toString());
            hum = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(3).toString());
            hia = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(4).toString());
            humaf = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(5).toString());
            hunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(6).toString());
            anta = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(7).toString());
            antuma = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(8).toString());
            antum = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(9).toString());
            anti = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(10).toString());
            antunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(11).toString());
            ana = sb.toString();
            ...
            sb.append(sarfSagheer.get(1).get(12).toString());
            nahnu = sb.toString();


        } else {

            hua = sarfSagheer.get(1).get(0).toString();
            huma = sarfSagheer.get(1).get(1).toString();
            hum = sarfSagheer.get(1).get(2).toString();
            hia = sarfSagheer.get(1).get(3).toString();
            humaf = sarfSagheer.get(1).get(4).toString();
            hunna = sarfSagheer.get(1).get(5).toString();
            anta = sarfSagheer.get(1).get(6).toString();
            antuma = sarfSagheer.get(1).get(7).toString();
            antum = sarfSagheer.get(1).get(8).toString();
            anti = sarfSagheer.get(1).get(9).toString();
            antumaf = sarfSagheer.get(1).get(4).toString();
            antunna = sarfSagheer.get(1).get(10).toString();
            ana = sarfSagheer.get(1).get(11).toString();
            nahnu = sarfSagheer.get(1).get(12).toString();
        }
    ...
    private void MudhariMaroof(ViewHolder holder) {
        String hua, huma, hum, hia, humaf, hunna, anta, antuma, antum, anti, antumaf, antunna, ana, nahnu;
        SharedPref sf = new SharedPref(context);
        Boolean isTraditional = SharedPref.GetSarfKabeerVerb();
        String[] arraypronouns = context.getResources().getStringArray(R.array.arabicpronouns);
        ...
        if (isTraditional) {
            ...
            sb.append(arraypronouns[0]);
            sb.append("-");
            sb.append(sarfSagheer.get(2).get(0).toString());
            hua = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(1).toString());
            huma = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(2).toString());
            hum = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(3).toString());
            hia = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(4).toString());
            humaf = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(5).toString());
            hunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(6).toString());
            anta = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(7).toString());
            antuma = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(8).toString());
            antum = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(9).toString());
            anti = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(10).toString());
            antunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(11).toString());
            ana = sb.toString();
            ...
            sb.append(sarfSagheer.get(2).get(12).toString());
            nahnu = sb.toString();


        } else {

            hua = sarfSagheer.get(2).get(0).toString();
            huma = sarfSagheer.get(2).get(1).toString();
            hum = sarfSagheer.get(2).get(2).toString();
            hia = sarfSagheer.get(2).get(3).toString();
            humaf = sarfSagheer.get(2).get(4).toString();
            hunna = sarfSagheer.get(2).get(5).toString();
            anta = sarfSagheer.get(2).get(6).toString();
            antuma = sarfSagheer.get(2).get(7).toString();
            antum = sarfSagheer.get(2).get(8).toString();
            anti = sarfSagheer.get(2).get(9).toString();
            antumaf = sarfSagheer.get(2).get(4).toString();
            antunna = sarfSagheer.get(2).get(10).toString();
            ana = sarfSagheer.get(2).get(11).toString();
            nahnu = sarfSagheer.get(2).get(12).toString();
    ...
    private void MadhiMaroof(ViewHolder holder) {
        String hua, huma, hum, hia, humaf, hunna, anta, antuma, antum, anti, antumaf, antunna, ana, nahnu;
        SharedPref sf = new SharedPref(context);
        Boolean isTraditional = SharedPref.GetSarfKabeerVerb();
        String[] arraypronouns = context.getResources().getStringArray(R.array.arabicpronouns);
        ...
        if (isTraditional) {
            ...
            sb.append(arraypronouns[0]);
            sb.append("-");
            sb.append(sarfSagheer.get(0).get(0).toString());
            hua = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(1).toString());
            huma = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(2).toString());
            hum = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(3).toString());
            hia = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(4).toString());
            humaf = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(5).toString());
            hunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(6).toString());
            anta = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(7).toString());
            antuma = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(8).toString());
            antum = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(9).toString());
            anti = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(10).toString());
            antunna = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(11).toString());
            ana = sb.toString();
            ...
            sb.append(sarfSagheer.get(0).get(12).toString());
            nahnu = sb.toString();
            ...
            hua = sarfSagheer.get(0).get(0).toString();
            huma = sarfSagheer.get(0).get(1).toString();
            hum = sarfSagheer.get(0).get(2).toString();
            hia = sarfSagheer.get(0).get(3).toString();
            humaf = sarfSagheer.get(0).get(4).toString();
            hunna = sarfSagheer.get(0).get(5).toString();
            anta = sarfSagheer.get(0).get(6).toString();
            antuma = sarfSagheer.get(0).get(7).toString();
            antum = sarfSagheer.get(0).get(8).toString();
            anti = sarfSagheer.get(0).get(9).toString();
            antumaf = sarfSagheer.get(0).get(7).toString();
            antunna = sarfSagheer.get(0).get(10).toString();
            ana = sarfSagheer.get(0).get(11).toString();
            nahnu = sarfSagheer.get(0).get(12).toString();
        }
